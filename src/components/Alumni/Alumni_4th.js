...
function Alumni_4th() {
  return(
    <div>
      ...
      {/*<CardDeck>*/}
      {/*  <Form name='김동희' emails='heeing519@gmail.com' major='경제학과 17학번' aImg={unknown} active="4기 활동"></Form>*/}
      ...
      {/*  <Form name='유현선' emails='s6465252@naver.com' major='사이버보안전공 17학번' aImg={unknown} active="4기 활동"></Form>*/}
      {/*  <Card className="Form" id="empty"></Card>*/}
      {/*  <Card className="Form" id="empty"></Card>*/}
      {/*</CardDeck>*/}
    </div>
  );
