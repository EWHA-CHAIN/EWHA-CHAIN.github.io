...
function Alumni_3rd() {
  return(
    <div>
      ...
      <div>
        <Form name='조연서' emails='justdustcluster@gmail.com' major='컴퓨터공학전공 19학번' aImg={unknown} active="4기 학회장 : 3-4기 활동"></Form>
        ...
        <Form name='문효진' emails='dkakfl56@gmail.com' major='컴퓨터공학전공 17학번' aImg={unknown} active="3-4기 활동"></Form>
      </div>
      <div>
        <Form name='백지희' emails='100jieeee@gmail.com' major='컴퓨터공학전공 17학번' aImg={unknown} active="3-4기 활동"></Form>
